 ...
 */
class SingleLoopBuy extends BaseModel
{
    // 设置数据表名
    public $name = "single_loop_buy";
    ...
    public function getLastQbTokenAttr($value)
    {
        return (float)$value;
    }
    ...
    public function getUpStopPerAttr($value)
    {
        return (float)$value;
    }

    public function getDownStopPerAttr($value)
    {
        return (float)$value;
    }
}
